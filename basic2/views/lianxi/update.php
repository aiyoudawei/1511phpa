...
<div class="left">
    <ul>
        <li><a href="index.php?r=lianxi/show">查看注册字段</a></li>
        <li><a href="index.php?r=lianxi/addone">添加注册字段</a></li>
        <li class="selected"><a href="#">修改字段</a></li>
    </ul>
</div>
    ...
    <div class="search-box">
        <form action="index.php?r=lianxi/update_do" method="post">
            ...
            <ul>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" class="filed-name" name="xx1" value="<?php echo $data['xx1'];?>" placeholder="选项1">
                    <input type="text" class="filed-name" name="xx2" value="<?php echo $data['xx2'];?>" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                   <input type="checkbox" name="required" checked="checked" value="1">必填
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" value="<?php echo $data['limit']?>" name="limit" placeholder="请输入最大长度">
                </li>
                <li>
