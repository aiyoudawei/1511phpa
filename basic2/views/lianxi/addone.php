...
<div class="right">
    <div class="search-box">
        <form action="index.php?r=lianxi/addone_do" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" class="filed-name" name="xx1" placeholder="选项1">
                    <input type="text" class="filed-name" name="xx2" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="checkbox" name="required" value="1">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                    <select name="rule" id="">
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" value="" name="limit" placeholder="请输入最大长度">
                </li>
                <li>
